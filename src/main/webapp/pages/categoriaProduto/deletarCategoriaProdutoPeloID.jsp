...
<h1 id="titulo-Editar-Pelo-ID">Deletar Categoria Produto por ID</h1> <!-- Título principal -->
<form action="${pageContext.request.contextPath}/DeletarCategoriaProdutoServlet" method="post"> <!-- Formulário para alteração -->
  ...
  <div class="infos-linha1"> <!-- Linha de informações -->
    ...
    <div class="ID">
      ...
      <input type="text" name="categoria_id" id="id" placeholder="Insira o ID"> <!-- Campo de entrada para Nome Novo -->
    </div>
