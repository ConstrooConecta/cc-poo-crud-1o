...
<form action="${pageContext.request.contextPath}/DeletarCategoriaProdutoServlet" method="post"> <!-- Formulário para alteração -->
  ...
  <div class="infos-linha"> <!-- Linha de informações -->
    <label for="categoria_id">Insira o ID do Categoria Produto</label> <!-- Rótulo para nome -->
    <input type="number" name="categoria_id" id="categoria_id" required> <!-- Campo de entrada para nome -->
  </div>
