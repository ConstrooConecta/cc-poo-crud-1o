...
<head>
    ...
    <link rel="shortcut icon" type="imagex/png" href="/imagens/LogoVersaoMenor.ico">
...
<div class="content">
    <div class="login">
        <img src="imagens/LogoAreaRestrita.svg" alt="" id="Imagem-Login">
        ...
        <form action="LoginServlet" method="post" class="formulario-login">
            ...
            <label>Senha *
                <br>
                <input type="password" name="senha-admin" placeholder="Insira sua senha" class="informacoes-admin">
            </label>
            <br><br>
